...
### 🔧 **Bug Fixes**
- Fixed Ethereal Changelogs
- Fixed misc reported bugs from beta releases
- Fixed depth wallpaper/media art inconsistencies/glitches
- Spoofing fixes and improvements to unlock google pixel features
---

### 🌟 **Features**
#### **ETHEREAL OS**
- New Ethereal version easter egg (maybe tap the EtherealOS version multiple times 😁)
...
### 🎨 **UI Enhancements**
- Keeping the system UI clean and bug free is one of our top priorities, for me **MORE CUSTOMIZATION = MORE BUGS** it's simple and easy.
---
...
**Disclaimer:** The Ethereal OS team may have made partial modifications to these features. However, it is essential to note that we do not assert or will NEVER assert ownership to any of these features, nor do we claim any part of them as our own. All copyrights and credits belong to their respective authors and contributors.
...
* [**RisingOS**](https://github.com/RisingOS-Revived/)
* [**CrDroid**](https://github.com/crdroidandroid)
* [**Every individual who has contributed to AOSP-based projects—whether through development, testing, or bug-fixing**]
